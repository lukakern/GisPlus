...
The resolution depends on the amount of pixel in each dimension. Because the amount of pixels in one dimension is defined as input in the function, the range is divided by this value to get the resolution.
Because the x- and y-range may differ, its mean is used in the above calculation.
...
\lstinputlisting[language=Python, firstline=114, lastline=135]{../rasterizer_function.py}
